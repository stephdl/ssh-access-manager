...
NGINX_PORT=8080
NGINX_TLS_CERT_PATH=  NGINX_TLS_KEY_PATH=
...
NGINX_TLS_CERT_PATH + NGINX_TLS_KEY_PATH : si les deux sont définis → Nginx écoute en HTTPS (TLS terminé sur Nginx, Flask reste HTTP interne sur 127.0.0.1:5000).
